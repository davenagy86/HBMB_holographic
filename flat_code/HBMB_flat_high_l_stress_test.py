...
# Flat high-l stress test for HBMB truncation on S^2:
...
# User settings
# -----------------------------------------------------------------------------
OUTDIR = Path("figs_flat_high_l_stress")
...
def main():
    ...
    plt.xlabel("l_max")
    plt.ylabel("Error")
    plt.title("Flat high-l stress test: reconstruction error vs cutoff (FAST)")
    plt.legend()
    plt.tight_layout()
    ...
    plt.xlabel("l_max")
    plt.ylabel("E(l_max)")
    plt.title("Flat high-l stress test: spectral coverage vs cutoff (FAST)")
    plt.legend()
    plt.tight_layout()
